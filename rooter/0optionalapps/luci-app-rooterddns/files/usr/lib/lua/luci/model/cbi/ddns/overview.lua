...
local_web="<p>&nbsp;</p><p>&nbsp;<input type=\"button\" class=\"cbi-button cbi-button-apply\" value=\" " .. "Change Global Settings" .. " \" onclick=\"window.open('http://'+window.location.host+'/cgi-bin/luci/admin/services/ddns/global')\"/></p>"

-- TableSection definition -- ##################################################
ts = m:section( TypedSection, "service",
	translate("Overview"),
	translate("Below is a list of DDNS configurations and their current state.")
	.. "<br />"
	.. "<br />" .. local_web )
